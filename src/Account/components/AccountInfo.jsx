...
const AccountInfo = () => {
  ...
  const { job, department, organization, location } = detailsData;
        ...
        <ul className='flex flex-col space-y-2 text-sm'>
          <li className='flex items-center space-x-2 relative'>
            ...
            <input
              ...
              id='job'
              name='job'
              value={editDetails ? detailsData.job : user?.jobTitle}
              onChange={onChange}
          ...
          <li className='flex items-center space-x-2'>
            ...
            <input
              ...
              id='department'
              name='department'
              value={editDetails ? detailsData.department : user?.department}
              onChange={onChange}
          ...
          <li className='flex items-center space-x-2'>
            ...
            <input
              ...
              name='organization'
              value={
                editDetails ? detailsData.organization : user?.organization
              }
              onChange={onChange}
              disabled={!editDetails}
